...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/calendar` | `/calendar` | `/(tabs)/dashboard` | `/dashboard` | `/(tabs)/messages` | `/messages` | `/(tabs)/profile` | `/profile` | `/+html` | `/modal` | `/settings`;
  // prettier-ignore
