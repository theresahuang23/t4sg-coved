...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/calendar` | `/calendar` | `/(tabs)/dashboard` | `/dashboard` | `/(tabs)/messages` | `/messages` | `/(tabs)/profile` | `/profile` | `/(tabs)/_layout` | `/_layout` | `/+html` | `/modal` | `/settings`;
  // prettier-ignore
